...
*/
 ...
 include_once(DIR_WS_MODULES . $template_dir . '/inc_fd.php'); // Frequency Discount
?>
...
if ($shownewsub) { 
   echo '<div id="cartNewSubTotal">';
   echo SUBTOTAL_POSTDISCOUNT . ": "; 
   echo $currencies->format($newsub, true, $order->info['currency'], $order->info['currency_value']);
   echo '</div>';
}
?>
<br class="clearBoth" />
